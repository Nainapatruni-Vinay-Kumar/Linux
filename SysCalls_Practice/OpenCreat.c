...
Sample_fd = creat("/home/vinay/Desktop/Vinay/C_Programs/SysCalls_Test/Sample3.txt",S_IRUSR);
if(Sample_fd == -1)
{
...
{
printf("Your file with id: %d, is opened using CREAT syscall and with R permissions to the user\n",Sample_fd);
